...
axes[1].set_title("After filtering (low frequency below 50th bin removed)")
...
plt.tight_layout()
plt.savefig("./2-12_spectrogram.png")
plt.show()
print("スペクトログラムを 2-12_spectrogram.png に保存しました")

#wavファイルとして保存
output_wav_file = "./2-12_output.wav"
